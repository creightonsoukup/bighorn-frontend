    ...
    return (
      <div className='neighborhood'>
        ...
        <section className='neighborhood-intro'>
          <Subheader text={content.neighborhood.intro.title.toUpperCase()} style={'subheader'}/>
          <p>{content.neighborhood.intro.paragraph1}</p>
        </section>
        <section >
          <Subheader style={'subheader'} text={'LAKEFRONT TO SLOPESIDE IN MINUTES'}/>
        ...
        <section className='neighborhood-section'>
          <Subheader style={'subheader'} text={'ENDLESS RECREATION'}/>
          <div className='neighborhood-section'>
        ...
        <section className='neighborhood-section'>
          <Subheader style={'subheader'} text={'JUST LOOKING FOR A VIEW?'}/>
          <div className='neighborhood-section'>
        ...
        <section className='neighborhood-section'>
          <Subheader style={'subheader '} text={'CALLING ALL HISTORY BUFFS'}/>
          <div className='neighborhood-section'>
